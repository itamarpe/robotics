...
class ArmController(object):
	...
	points = []
        ...
        #dest_pose.position.x = points[0].position.x + 0.05
        #dest_pose.position.y = points[0].position.y 
        #dest_pose.position.z = points[0].position.z 
        dest_pose.position.x = self.cartesian_point.x + points[0].position.x
        dest_pose.position.y = self.cartesian_point.y + points[0].position.y #points[0].position.y
        dest_pose.position.z = self.cartesian_point.z + points[0].position.z
